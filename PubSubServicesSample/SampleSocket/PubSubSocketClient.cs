...
namespace PubSubServicesSample.SampleSocket
{
    public class PubSubSocketClient : IDisposable
    {
        readonly System.Net.Sockets.Socket _client;
        ...
        public PubSubSocketClient(string serverIp = "127.0.0.1", int serverPort = 12345)
        {
            ...
            _client = new System.Net.Sockets.Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
